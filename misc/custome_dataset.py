...
class CustomedDataset(Dataset):
    ...
    def __init__(self, img_files, labels, class_attributes=None, num_shots=None,
    ...
    def consume(self, dataset_loader):
        other_image_files = dataset_loader.dataset.image_files
        other_labels = dataset_loader.dataset.labels
        self.image_files = np.concatenate([self.image_files, other_image_files], axis=0)
        self.labels = np.concatenate([self.labels, other_labels])
